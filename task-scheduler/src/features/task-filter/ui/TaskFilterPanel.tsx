    ...
    >
      ...
      {actualIsOpen && (
        <div style={dropdownStyle}>
          ...
          >
            <span
              style={{ fontWeight: "600", color: currentTheme.colors.text }}
            >
              Фильтрация задач
            </span>
            {activeFilterCount() > 0 && (
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontSize: "12px",
                  backgroundColor:
                    localFilters.priorityFilterType === "none"
            ...
            {(localFilters.priorityFilterType === "exact" ||
              ...
              <div>
                <input
                  ...
                  onChange={(e) =>
                    handlePriorityValueChange(parseInt(e.target.value))
                  }
                  style={{ width: "100%" }}
                />
                <div
              ...
              <div>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handlePriorityRangeChange(
                        parseInt(e.target.value),
                        localFilters.priorityMax,
                      )
                    }
                    style={{ flex: 1 }}
                  />
                  <span style={{ fontWeight: "bold", minWidth: "30px" }}>
                    {localFilters.priorityMin}
                  </span>
                </div>
                <div
                  style={{
